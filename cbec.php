...
<?php include 'navbar.php'; ?>
    <title>Fabric Yardage Calculator - Custom Bench Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Custom Bench Cushions</h1>
    <form id="customBenchCushionCalcForm">
    ...
    <script>
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for Custom Bench Cushions
            let fabricYardage;
            let bandWidth;
            let bandLength;
            let facesWidth;
            ...
            facesWidth = cushionWidth * 2 + (2 * cushionThickness) + fabricPattern;
            facesLength = cushionLength * 2 + (2 * cushionThickness) + fabricPattern;
