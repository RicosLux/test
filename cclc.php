...
<head>
    ...
    <title>Fabric Yardage Calculator - Custom Chaise Lounger Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Custom Chaise Lounger Cushions</h1>
    <form id="cclcCalcForm">
    ...
    <script>
        ...
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for custom chaise lounger cushions
            const facesWidth = (cushionWidth + fabricPattern) * 2;
            const facesLength = (cushionLength + fabricPattern) * 2;
            const fabricYardage = (facesWidth / 36) + (facesLength / 36) * quantity; // Fixed the calculation here
