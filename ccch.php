...
<?php include 'navbar.php'; ?>
    <title>Fabric Yardage Calculator - Custom Chaise Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Custom Chaise Cushions</h1>
    <form id="ccchCalcForm">
    ...
    <script>
        ...
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for custom chaise cushions
