...
<?php include 'navbar.php'; ?>
    <title>Fabric Yardage Calculator - Custom Ottoman Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Custom Ottoman Cushions</h1>
    <form id="cocCalcForm">
    ...
    <script>
        ...
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for custom ottoman cushions
