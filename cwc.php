...
<?php include 'navbar.php'; ?>
    <title>Fabric Yardage Calculator - Custom Wicker Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Custom Wicker Cushions</h1>
    <form id="cwcCalcForm">
    ...
    <script>
        ...
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for custom wicker cushions
