...
<?php include 'navbar.php'; ?>
    <title>Fabric Yardage Calculator - Custom Chair Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Custom Chair Cushions</h1>
    <form id="ccucCalcForm">
    ...
    <script>
        ...
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for custom chair cushions
