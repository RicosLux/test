...
<?php include 'navbar.php'; ?>
    <title>Fabric Yardage Calculator - Quick Ship Value Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Quick Ship Value Cushions</h1>
    <form id="qsvcCalcForm">
    ...
    <script>
        ...
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for quick ship value cushions
