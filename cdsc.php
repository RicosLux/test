...
<?php include 'navbar.php'; ?>
    <title>Fabric Yardage Calculator - Custom Deep Seating Cushions</title>
</head>
<body>
    <h1>Fabric Yardage Calculator - Custom Deep Seating Cushions</h1>
    <form id="cdscCalcForm">
    ...
    <script>
        ...
        function calculateFabricYardage() {
            ...
            // Calculate fabric yardage for custom deep seating cushions
